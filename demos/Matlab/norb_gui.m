function varargout = norb_gui(varargin)
% A GUI-demo for Convolutional neural network trained on NORB dataset
%
% Requires NORB dataset, which can be downloaded from http://www.cs.nyu.edu/~ylclab/data/norb-v1.0/
%
